...
class LoginMessages with ChangeNotifier {
  LoginMessages({
    ...
    this.emailRecoveryHint = defaultUsernameHint,
  ...
  static const defaultEmailRecoveryHint = 'Email';
  ...
  /// Hint text of the user email [TextField]
  final String emailRecoveryHint;
